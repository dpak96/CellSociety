...
public class SimulationFactory {
	 ...
	 * @param width
	 */
	public SimulationFactory(GridPane grid, GUI gui, Map<String, Double> map,
	...
	/**
	 * converts string for name of simulation into string for name of xml file
	 * to initialize given simulation
	 *
	 * @param simulation
	 * @return
