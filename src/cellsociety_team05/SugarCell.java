...
public class SugarCell extends Cell {
    ...
    public SugarCell (int xCoordinate,
        ...
        myColors =
                new Color[] { Color.WHITE, Color.YELLOW, Color.GOLD, Color.ORANGE, Color.RED,
                              Color.BLACK };
    ...
    public void preUpdateCell () {
        ...
        if (myCurrentState == 5 && myDirty == false) {
            if (mySim.myAgentSugars[getX()][getY()] == 0) {
                ...
                mySim.myAgentSugars[moveCell.getX()][moveCell.getY()] =
                        mySim.myAgentSugars[getX()][getY()] - mySim.myMetabolism;
                moveCell.setMyDirty(true);
            }
        }
        if (mySim.myTimes[getX()][getY()] % mySim.myInterval == 0 &&
            mySim.mySugars[getX()][getY()] < mySugarLimit && myNextState != 5) {
