...
public class ToroidGrid extends Grid {
    ...
    public ToroidGrid (int width, int height, Simulation sim, Map<String, Double> map) {
        ...
        for (List<Cell> list : myCells) {
            for (Cell cell : list) {
                ...
                for (int i = 0; i < x.length; i++) {
                    ...
                    else if (xCoordinate >= myCells.size() && yCoordinate >= 0 &&
                             yCoordinate < myCells.get(0).size()) {
                    ...
                    else if (yCoordinate >= myCells.get(0).size() && xCoordinate >= 0 &&
