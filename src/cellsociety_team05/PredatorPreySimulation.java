...
public class PredatorPreySimulation extends Simulation {
	 ...
	 * @param width
	 */
	public PredatorPreySimulation(GridPane gridPane, GUI gui,
		...
		try {
			PREY_REPRODUCTION_TIME = (int) Math.round(params
		...
		try {
			PREDATOR_REPRODUCTION_TIME = (int) Math.round(params
	...
	public Cell makeCell(int x, int y, int start, Grid g,
		...
		params.put("predatorreproductiontime",
				map.get("predatorreproductiontime"));
		params.put("energylimit", map.get("energylimit"));
		PredatorPreyCell c = new PredatorPreyCell(x, y, start, params, myGrid,
				this);
		return c;
	}
	...
	/**
	 * @param pREY_REPRODUCTION_TIME
	 *            the pREY_REPRODUCTION_TIME to set
	 */
	...
	/**
	 * @param pREDATOR_REPRODUCTION_TIME
	 *            the pREDATOR_REPRODUCTION_TIME to set
	 */
	...
	/**
	 * @param pREDATOR_ENERGY
	 *            the pREDATOR_ENERGY to set
	 */
	...
	/**
	 * @param myReproductionTimes
	 *            the myReproductionTimes to set
	 */
