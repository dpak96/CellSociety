...
public class PredatorPreyCell extends Cell {
     ...
     * @param sim
     */
    public PredatorPreyCell (int xCoordinate,
                             int yCoordinate,
                             int startingState,
            ...
            for (Cell cell : list) {
                ...
                for (int i = 0; i < x.length; i++) {
                    ...
                    if (xCoordinate >= 0 && yCoordinate >= 0 &&
                        ...
                        yCoordinate < myGrid.getCellMatrix().get(0).size()) {
                        ...
                        neighbors.add(myGrid.getCellMatrix().get(myGrid.getCellMatrix().size() - 1)
                                .get(yCoordinate));
                    }
    ...
    private void moveTo (Cell cell) {
        ...
        mySim.getMyReproductionTimes()[cell.getX()][cell.getY()] =
                mySim.getMyReproductionTimes()[getX()][getY()];
    ...
    private void age (Cell cell) {
        mySim.getMyEnergies()[cell.getX()][cell.getY()] =
                mySim.getMyEnergies()[cell.getX()][cell.getY()] + 1;
        mySim.getMyReproductionTimes()[cell.getX()][cell.getY()] =
                mySim.getMyReproductionTimes()[cell.getX()][cell.getY()] + 1;
    }
        ...
        if (!myDirty) {
            if (myCurrentState == 1) {
                ...
                if (fish.size() > 0) {
                    ...
                    eat(eatCell);
                    if (mySim
                            .getMyReproductionTimes()[getX()][getY()] >= PREDATOR_REPRODUCTION_TIME) {
